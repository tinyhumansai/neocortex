...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\linewidth]{figures/purkinje-cell.png}
...
The Ebbinghaus forgetting curve complements this view by formalizing a
second constraint: \emph{retention must decay unless reinforced}. Human
memory is adaptive precisely because it forgets low-value details while
preserving repeatedly useful structure. A practical AI memory system
