...
// Canonical Mastra tool names/descriptions (tool surface match).
// Note: intentionally excludes `neocortex_get_graph_snapshot` to match the
// "all tools except neocortex_get_graph_snapshot" requirement.
